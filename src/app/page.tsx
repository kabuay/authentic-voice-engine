...
export default function Home() {
  ...
  const handleEmailSignIn = async () => {
    ...
    try {
      ...
      setAuthError(parseAuthError(error.code));
    } finally {
            ...
            {!user ? (
              <div className="flex flex-col gap-5 border-t border-white/10 pt-6">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 bg-white text-black hover:bg-gray-100 px-6 py-4 rounded-full font-semibold transition-all shadow-[0_0_20px_rgba(255,255,255,0.15)] hover:shadow-[0_0_30px_rgba(255,255,255,0.35)] active:scale-95 duration-300"
                >
                ...
                <div className="flex flex-col gap-3">
                  <input
                    ...
                    className="glass-input px-5 py-3.5 text-[15px]"
                    autoComplete="email"
                  />
                  <input
                    id="vault-password"
                  ...
                  {/* Error message */}
                  {authError && (
                    <p className="text-red-400 text-sm font-medium px-1 animate-[fadeIn_0.2s_ease-out]">{authError}</p>
                  )}
                ...
                <button
                  ...
                  disabled={authActionLoading}
                  className="w-full flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 border border-white/10 px-6 py-3.5 rounded-full text-white/60 hover:text-white font-medium transition-all active:scale-95 disabled:opacity-50"
                >
